...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/extentos/swift-glasses/releases/download/2.8.0/extentos_coreFFI.xcframework.zip",
            checksum: "1842b25f0baec0fec0b2034d6b5ffcbe076c6b16ded1d0822e7010bbd515bbaf"
        ),
        .target(
            name: "GlassesCore",
            dependencies: [
        ...
        .binaryTarget(
            name: "sherpaOnnxFFI",
            url: "https://github.com/extentos/swift-glasses/releases/download/2.8.0/sherpaOnnxFFI.xcframework.zip",
            checksum: "0c096eeed79c54e5db00e71fc0589a3e4213df6163b3f566c7222d936d1c2660"
        ),
        .binaryTarget(
            name: "onnxruntimeFFI",
            url: "https://github.com/extentos/swift-glasses/releases/download/2.8.0/onnxruntimeFFI.xcframework.zip",
            checksum: "62271b99157b926612e7108ef0d29fa8e2dbdc22c9287aff49be96a0a8851642"
        ),
        .target(
