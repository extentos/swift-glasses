...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/extentos/swift-glasses/releases/download/1.7.0-rc1/extentos_coreFFI.xcframework.zip",
            checksum: "310cddc34290e7b7b2f83b8e218b8c8c2462a55f794c58f5fea42702034da456"
        ),
        .target(
            name: "GlassesCore",
            dependencies: [
